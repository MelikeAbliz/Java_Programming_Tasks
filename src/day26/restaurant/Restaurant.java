...
4.3 Create a class called Restaurant
	            ...
	            Actions: (all void methods)
	                ...
	                toString(): Return (String) all the information on a Restaurant object.
	                No need to print the whole list of Servers or Chefs. Print the number of Servers
	                and Chefs alongside the other information.
