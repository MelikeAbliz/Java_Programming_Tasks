...
public class CydeoStudents {
    public static void main(String[] args) {
        ...
        batch1Groups[0] = batch1Group1;//Assign batch1Group1, batch1Group2, batch1Group1 to each indexes of the variable batch1Groups
        ...
        batch2Groups[0] = batch2Group1;//Assign batch2Group1, batch2Group2, batch2Group1 to each indexes of the variable batch2Groups
        batch2Groups[1] = batch2Group2;
        batch2Groups[2] = batch2Group3;

        String[][][] cydeoStudents = new String[2][][];//declare an array variable named CydeoStudents
        cydeoStudents[0] = batch1Groups;//assign batch1Groups & batch2Groups to the indexes of CydeoStudents
        cydeoStudents[1] = batch2Groups;
        for (String[][] cydeoGroups : cydeoStudents) {
            for (String[] group : cydeoGroups) {
                for (String eachStudent : group) {
                    System.out.print(eachStudent + ",");//6. Print the names of each student
                }
            }
        }
